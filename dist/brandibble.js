...
/***/ function(module, exports, __webpack_require__) {
	...
	var _customers = __webpack_require__(11);
	...
	var _addresses = __webpack_require__(13);

	var _addresses2 = _interopRequireDefault(_addresses);

	var _menus = __webpack_require__(14);
	  ...
	  _createClass(Customers, [{
	    ...
	    value: function authenticate(body) {
	      ...
	      return this.token(body).then(function (response) {
	        _this.adapter.persistCustomerToken(response.data.token);
	    ...
	    value: function invalidate() {
	      ...
	      return new Promise(function (resolve) {
	        _this2.adapter.flushCustomerToken();
	        resolve(true);
	      });
	    }
	  }, {
