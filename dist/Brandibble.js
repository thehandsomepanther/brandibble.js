...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Fetcher = __webpack_require__(2);

	var _Fetcher2 = _interopRequireDefault(_Fetcher);

	var _Customers = __webpack_require__(4);
	...
	var Brandibble = function Brandibble(_ref) {
	  ...
	  this.Fetcher = new _Fetcher2.default({ apiKey: apiKey, apiBase: apiBase });
	  this.Customers = new _Customers2.default(this.Fetcher);
	...
	var Fetcher = function () {
	  ...
	  _createClass(Fetcher, [{
	    ...
	    value: function makeRequest(method, path) {
	      ...
	      return (0, _whatwgFetch2.default)();
	    }
	  }, {
	    key: 'getCustomerId',
