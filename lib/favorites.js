...
export default class Favorites {
  ...
  static buildLineItem(favorite, menuJSON) {
    const product = find(menuJSON.products, p => p.id === favorite.product_id);
    if (!product) return;
    ...
    return { favoriteId: favorite.id, lineItem, menuId: menuJSON.id };
  }
